...
namespace GoFishWPF
{
    class Player
    {
        ...
        public Deck DoYouHaveAny(Values value)
        {
            ...
            textBoxOnForm.Content += Name + " has " + foundCards.Count + " " + Card.Plural(value) + Environment.NewLine;
        ...
        {
            textBoxOnForm.Content += Name + " asks if anyone has a " + value.ToString() + Environment.NewLine;
            ...
            {
                TakeCard(stock.Deal());
                textBoxOnForm.Content += Name + " had to draw from the stock." + Environment.NewLine;
            }
        }
